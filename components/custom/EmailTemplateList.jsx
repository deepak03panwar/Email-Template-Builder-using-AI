...
function EmailTemplateList() {
  ...
  return (
    <div>
        ...
        {emailList?.length == 0 ? 
        <div className='flex justify-center mt-7 flex-col items-center mt-10'>
          <Image src={'/email.png'} alt='email' width={250} height={250}  priority/>
       ...
       :
          <div className='grid grid-cols-2  md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-5'>
            {emailList?.map((item,index)=>(
              <div key={index} className='p-5 rounded-lg shadow-lg border'>
                <Image src={'/emailbox.png'} alt='email' width={200} height={200} priority
                className='w-full'/>
                <div>
